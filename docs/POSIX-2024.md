...
|---|---|---|
| present | 712 | defined by `libferrousli.a`, or a macro the standard specifies as one and `include/` defines |
...
| absent | 489 | not there |

531 interfaces are missing in one of the last four ways. 116 of them are
