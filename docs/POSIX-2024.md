...
|---|---|---|
| present | 864 | defined by `libferrousli.a`, or a macro the standard specifies as one and `include/` defines |
...
| absent | 372 | not there |

379 interfaces are missing in one of the last four ways. 71 of them are
