...
|---|---|---|
| present | 821 | defined by `libferrousli.a`, or a macro the standard specifies as one and `include/` defines |
...
| absent | 415 | not there |

422 interfaces are missing in one of the last four ways. 114 of them are
