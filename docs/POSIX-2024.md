...
|---|---|---|
| present | 981 | defined by `libferrousli.a`, or a macro the standard specifies as one and `include/` defines |
...
| absent | 255 | not there |

262 interfaces are missing in one of the last four ways. None of them is
