...
|---|---|---|
| present | 808 | defined by `libferrousli.a`, or a macro the standard specifies as one and `include/` defines |
...
| absent | 428 | not there |

435 interfaces are missing in one of the last four ways. 114 of them are
...
| Wide and multibyte characters | 118 | 13 | 0 | 7 | the formatted wide functions, `fwprintf` to `vwscanf` 5; `open_wmemstream` 2. Landed: wide-character stream I/O (`fgetwc`, `fgetws`, `fputwc`, `fputws`, `getwc`, `getwchar`, `putwc`, `putwchar`, `ungetwc`, `fwide`); the `wcstol` and `wcstod` families with `wcstoimax` and `wcstoumax`; `wcsftime`, `wcslcpy`, `wcslcat` |
...
| `<wchar.h>` | present (63) | `btowc`, `fgetwc`, `fgetws`, `fputwc`, `fputws`, `fwide`, `getwc`, `getwchar`, `mbrlen`, `mbrtowc`, `mbsinit`, `mbsnrtowcs`, `mbsrtowcs`, `putwc`, `putwchar`, `ungetwc`, `wcpcpy`, `wcpncpy`, `wcrtomb`, `wcscasecmp`, `wcscasecmp_l`, `wcscat`, `wcschr`, `wcscmp`, `wcscoll`, `wcscoll_l`, `wcscpy`, `wcscspn`, `wcsdup`, `wcsftime`, `wcslcat`, `wcslcpy`, `wcslen`, `wcsncasecmp`, `wcsncasecmp_l`, `wcsncat`, `wcsncmp`, `wcsncpy`, `wcsnlen`, `wcsnrtombs`, `wcspbrk`, `wcsrchr`, `wcsrtombs`, `wcsspn`, `wcsstr`, `wcstod`, `wcstof`, `wcstok`, `wcstol`, `wcstold`, `wcstoll`, `wcstoul`, `wcstoull`, `wcswidth` (XSI), `wcsxfrm`, `wcsxfrm_l`, `wctob`, `wcwidth` (XSI), `wmemchr`, `wmemcmp`, `wmemcpy`, `wmemmove`, `wmemset` |
| `<wchar.h>` | absent (13) | `fwprintf`, `fwscanf`, `open_wmemstream`, `swprintf`, `swscanf`, `vfwprintf`, `vfwscanf`, `vswprintf`, `vswscanf`, `vwprintf`, `vwscanf`, `wprintf`, `wscanf` |
