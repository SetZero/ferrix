...
|---|---|---|
| present | 935 | defined by `libferrousli.a`, or a macro the standard specifies as one and `include/` defines |
...
| absent | 301 | not there |

308 interfaces are missing in one of the last four ways. None of them is
