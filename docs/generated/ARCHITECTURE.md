...
13 files, 16 packages, 1430 elements, 157 relations. Model digest `5e0879fa0a1d0cfe`.
...
| `libs/linux-abi` | `#writtenAhead` | 7 | `forbid` | 70 | Three system call number tables, not two: x86-64's own, AArch64's generic one, and ARMv7-A's EABI one. |
