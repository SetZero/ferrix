...
| open | Stage 8's list (14), `AF_UNIX` 3b the in-flight cycle pass (3) and 3c credentials (2), stage 10's BAR trust (8, first piece landed), `timerfd` (3), dynamic linking (39, kernel half, `DT_RUNPATH`, `DT_FINI_ARRAY`, `DT_FINI` and x86-64 initial-exec TLS done 2026-09-21), stage 12 |
