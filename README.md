...
Run `scripts/fetch-rustc-sysroot.sh` again to add Cargo to a sysroot made
before this change. Boots with the toolchain use 4 GiB RAM unless `--memory` overrides
