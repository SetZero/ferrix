...
impl F80 {
    ...
    /// The value with these ten bytes.
    #[inline]
    pub(crate) const fn from_bytes(bytes: [u8; 10]) -> Self {
        Self { bytes }
    }
...
pub(crate) mod tests {
    ...
    fn arithmetic_rounds_in_the_current_mode_and_raises() {
        ...
        assert_eq!(parts(three.mul(three)), (0x9000_0000_0000_0000, 0x4003));
    ...
    fn conversions_and_remainders() {
        ...
        assert_eq!(parts(half.rndint_with_control(0x0b)), (0xc000_0000_0000_0000, 0x4000));
