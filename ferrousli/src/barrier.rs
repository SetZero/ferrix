...
fn private_wait(b: &Barrier, limit: c_int) -> c_int {
    ...
    {
        futex::wake(&inst.finished, 1, true);
    }
    0
}
...
#[cfg_attr(not(test), unsafe(no_mangle))]
pub unsafe extern "C" fn pthread_barrierattr_setpshared(attr: *mut BarrierAttr, shared: c_int) -> c_int {
