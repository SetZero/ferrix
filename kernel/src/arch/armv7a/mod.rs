...
///
/// ```text
///   mmap2(NULL, 0x800000, PROT_READ | PROT_WRITE, MAP_PRIVATE | MAP_ANONYMOUS, -1, 0) -> r0
///   loop: strb r2, [r0] ; add r0, r0, #4096 ; until r0 is 0x800000 past the start
///   exit_group(0), or exit_group(1) for a refused mmap2
/// ```
///
/// Assembled with binutils' `as` and read back out of the object file. ARM state.
pub(crate) const USER_OOM_PROGRAM: &[u8] = &[
    0x00, 0x00, 0xa0, 0xe3, 0x02, 0x15, 0xa0, 0xe3, 0x03, 0x20, 0xa0, 0xe3, 0x22, 0x30, 0xa0, 0xe3,
    0x00, 0x40, 0xe0, 0xe3, 0x00, 0x50, 0xa0, 0xe3, 0xc0, 0x70, 0xa0, 0xe3, 0x00, 0x00, 0x00, 0xef,
    0x01, 0x0a, 0x70, 0xe3, 0x07, 0x00, 0x00, 0x8a, 0x02, 0x15, 0x80, 0xe2, 0x01, 0x20, 0xa0, 0xe3,
    0x00, 0x20, 0xc0, 0xe5, 0x01, 0x0a, 0x80, 0xe2, 0x01, 0x00, 0x50, 0xe1, 0xfb, 0xff, 0xff, 0x3a,
    0x00, 0x00, 0xa0, 0xe3, 0x00, 0x00, 0x00, 0xea, 0x01, 0x00, 0xa0, 0xe3, 0xf8, 0x70, 0xa0, 0xe3,
