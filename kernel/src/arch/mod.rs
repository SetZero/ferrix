...
pub(crate) use aarch64::{
    ...
    ipi_irq, prepare_stack, prepare_user_root, report_trap, send_ipi_to_others, service_interrupts,
    set_cpu_local, shutdown, switch_to, timer_arm, timer_disarm, timer_irq, uninstall_user_root,
