...
pub(crate) use aarch64::{
    ...
    TrapFrame, USER_NATIVE_PROGRAM, USER_SPIN_PROGRAM, USER_TEST_PROGRAM, USER_TEST_STATUS,
    UserState, advance_past_breakpoint, breakpoint, classify, console, counter_hz, counter_now,
