...
pub(crate) use aarch64::{
    ...
    cpu_local_register, decode_syscall, describe_cpus, disable_interrupts, drain_console,
    ...
    interrupts_enabled, ipi_irq, kernel_write_protected, mask_interrupt, memory_barrier, msi_allocate,
    ...
    timer_irq, uninstall_user_root, unmask_interrupt, user_hwcaps, wait_for_interrupt,
    wait_for_work,
};
#[cfg(target_arch = "arm")]
