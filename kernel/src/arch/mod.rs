...
pub(crate) use aarch64::{
    ...
    flush_tlb, halt, hardware_id, identity_root, init_console, init_interrupts, init_traps,
    install_user_root, ipi_irq, prepare_stack, prepare_user_root, report_trap, send_ipi_to_others,
