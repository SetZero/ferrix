...
pub(crate) use aarch64::{
    ...
    init_traps, install_user_root, ipi_irq, prepare_stack, prepare_user_root, report_trap,
    send_ipi_to_others, service_interrupts, set_cpu_local, shutdown, switch_to, timer_arm,
    timer_disarm, timer_irq, uninstall_user_root, wait_for_interrupt, wait_for_work,
};
#[cfg(target_arch = "arm")]
